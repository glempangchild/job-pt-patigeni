			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="{{('template/assets/img/user.png')}}" class="img-circle" alt="Avatar"> <span>{{Auth::user()->name}}</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
							<ul class="dropdown-menu">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="{{url('/penduduk')}}" class="active"><i class="lnr lnr-home"></i> <span>Data Penduduk</span></a></li>
						@if (auth()->user()->level == 1)
							<li><a href="{{url('/user-activity')}}" class="active"><i class="lnr lnr-home"></i> <span>Aktivitas User</span></a></li>
						@endif
					</ul>
				</nav>
			</div>
